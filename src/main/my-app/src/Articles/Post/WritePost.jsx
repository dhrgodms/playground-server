...
const WritePost = () => {
    ...
    async function handleCommentSubmit(e) {
        ...
        try {
            axios
                .post('http://ok-archive.com:2023/api/comment/add', {
    ...
    async function handleLikes(e) {
        ...
        try {
            axios
                .get(`http://ok-archive.com:2023/api/post/like/${id}`)
                .then(res => {
                    console.log(res);
                    if (res?.data) {
    ...
    useEffect(() => {
        ...
        axios.get(`http://ok-archive.com:2023/api/comment/all/${id}`).then(response => {
            setCommentAll(response.data);
        }).catch(error=>console.log(error));
        console.log(writePost.tag);
        (writePost.tag===2&&images.length<1)&&axios.get(`http://ok-archive.com:2023/api/image/all/${id}`).then(response => {
